package com.example.myhelloapp.frontend
...
import com.example.myhelloapp.PreferencesManager
import com.example.myhelloapp.data.RegisterData
import com.example.myhelloapp.service.RegisterService
    ...
    Scaffold (
        ...
        Column (modifier = Modifier
            ...
            ElevatedButton(onClick = {
                if (username.text.isBlank() || email.text.isBlank() || password.text.isBlank()) {
                    var yangMana = if (username.text.isBlank()) {
                        "username"
